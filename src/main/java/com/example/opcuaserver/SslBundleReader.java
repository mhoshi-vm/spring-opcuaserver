...
class SslBundleReader {
    ...
    private final ImmutableList<X509Certificate> acceptedIssuers;

    SslBundleReader(SslBundles sslBundles, @Value("${bundle.name:self-signed}") String bundleName) throws KeyStoreException, UnrecoverableEntryException, NoSuchAlgorithmException, CertificateParsingException {
        ...
        this.acceptedIssuers = ImmutableList.copyOf(acceptedIssuers);
    ...
    public ImmutableList<X509Certificate> getAcceptedIssuers() {
